          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="prose prose-lg">
              ...
              <p className="text-slate-600 leading-[1.75]">
                Terragence Instruments  is a trusted trading company, based in India, specializing in Electrical, Mechanical, Instrumentation, and Medical Products. We work with global manufacturers and suppliers to provide industries with high-quality, tested products.
              </p><br/>
              <p className="text-slate-600 leading-[1.75]">
